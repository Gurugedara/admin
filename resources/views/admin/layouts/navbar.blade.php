<nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
    ...
    <a class="mdl-navigation__link {{Request::is('admin/teacherVerify')?'mdl-navigation__link--current':null}}" href="teacherVerify"><i class="mdl-color-text--blue-grey-400 material-icons">person</i>Verify Teachers</a>
    <a class="mdl-navigation__link {{Request::is('admin/courses')?'mdl-navigation__link--current':null}}" href="courses" ><i class="mdl-color-text--blue-grey-400 material-icons" >add</i>Add Courses</a>
